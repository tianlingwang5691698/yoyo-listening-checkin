...
const RELEASE = '20260727-classic-v1';
const NAMES = [
  'ad-goku-bulma-quest.jpg',
  'ad-kame-training.jpg',
  'home-kid-goku-nimbus.jpg',
  'subpages/listening-goku-bulma-radio.jpg',
  'subpages/reading-goku-bulma-map.jpg',
  'subpages/grammar-roshi-goku-krillin.jpg',
  'subpages/writing-bulma-goku-journal.jpg',
  'subpages/speaking-goku-krillin-roshi.jpg',
  'subpages/vocabulary-goku-oolong-puar.jpg',
  'subpages/record-kame-training-progress.jpg',
  'subpages/parent-grandpa-gohan-goku.jpg',
  'subpages/profile-kid-goku.jpg'
];
const ASSETS = NAMES.map((name) => ({
  name,
  localPath: path.join(ROOT, 'assets', 'dragon-classic-v1', name),
  cloudPath: `_assets/themes/dragon/${RELEASE}/${name}`
}));
