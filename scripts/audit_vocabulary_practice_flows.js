...
async function main() {
  ...
  try {
    ...
    await home.callMethod('openWordPractice');
    await home.waitFor(250);
    ...
    console.log(JSON.stringify({ ok: true, level: LEVEL, learnedWords: data.availableCount, screenshots: [menuScreenshot, wordScreenshot, audioScreenshot] }, null, 2));
  } finally {
