...
const RELEASE = '20260727-ad2-v3';
const NAME = 'ad-luffy-sanji-breakfast-750x620-v3.jpg';
const LOCAL_PATH = path.join(ROOT, 'assets', 'voyage-framed-v2', NAME);
const CLOUD_PATH = `_assets/themes/voyage/${RELEASE}/${NAME}`;
