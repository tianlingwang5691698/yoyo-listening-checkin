...
const actionMap = {
  ...
  getListeningMaterialCatalog: serviceAction('listeningPlan', 'getListeningMaterialCatalog'),
  ...
  generateIeltsSpeakingReportPdf: serviceAction('speaking', 'generateIeltsSpeakingReportPdf'),
  ...
  generateListeningReportPdf: serviceAction('listening', 'generateListeningReportPdf'),
  getFlashcardReview: serviceAction('flashcard', 'getFlashcardReview'),
  getFlashcardDue: serviceAction('flashcard', 'getFlashcardDue'),
  getJuniorVocabularyPlan: serviceAction('flashcard', 'getJuniorVocabularyPlan'),
  saveJuniorVocabularyPlanDuration: serviceAction('flashcard', 'saveJuniorVocabularyPlanDuration'),
  completeJuniorVocabularyPlan: serviceAction('flashcard', 'completeJuniorVocabularyPlan'),
  ...
  saveVocabularyDictationAttempt: serviceAction('flashcard', 'saveVocabularyDictationAttempt'),
  getVocabularyDictationData: serviceAction('flashcard', 'getVocabularyDictationData'),
  getVocabularyDictationHistory: serviceAction('flashcard', 'getVocabularyDictationHistory'),
  getVocabularyDictationSourceCounts: serviceAction('flashcard', 'getVocabularyDictationSourceCounts'),
  getVocabularyDictationSourceWords: serviceAction('flashcard', 'getVocabularyDictationSourceWords'),
  getVocabularyDictationAttemptDetail: serviceAction('flashcard', 'getVocabularyDictationAttemptDetail'),
  ...
  generateReadingReportPdf: serviceAction('reading', 'generateReadingReportPdf'),
  getGrammarHome: serviceAction('grammar', 'getGrammarHome'),
  getGrammarTopic: serviceAction('grammar', 'getGrammarTopic'),
  getGrammarClassroomCourse: serviceAction('grammar', 'getGrammarClassroomCourse'),
  ...
  getGrammarNarrationAudio: serviceAction('grammar', 'getGrammarNarrationAudio'),
  explainGrammarQuestion: serviceAction('grammar', 'explainGrammarQuestion'),
  analyzeWritingTranslation: serviceAction('writing', 'analyzeWritingTranslation'),
  ...
  generateWritingBandSample: serviceAction('writing', 'generateWritingBandSample'),
  generateWritingReportPdf: serviceAction('writing', 'generateWritingReportPdf'),
