...
### 2026-07-22 佑佑 Unlock 1 每日跟读计划

- 从 2026-07-23 起，阶段二每日新增 Unlock 1 听口第二版跟读：每天 2 段、约 6–10 句、约 5–8 分钟；前 68 天完整覆盖现有 135 段，后 4 天安排巩固复习。
- 首页今日计划和阶段页显示每段逐句完成进度；点击任务直达指定音频与段落，复用现有原音、transcript、录音和腾讯 SOE 评分。
