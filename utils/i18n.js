...
const TEXTS = {
  'zh-CN': {
    ...
    'settings.voyageTheme': '伟大航路',
    'settings.dragonTheme': '龙珠修炼',
    'settings.tacticalTheme': '战术行动',
  ...
  en: {
    ...
    'settings.voyageTheme': 'Grand Voyage',
    'settings.dragonTheme': 'Dragon Training',
    'settings.tacticalTheme': 'Tactical Ops',
