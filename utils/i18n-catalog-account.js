module.exports = {
  ...
  parentDetail: {
    'zh-CN': {
      ...
      memorization: '背诵', dictation: '听写', wordMeaning: '看词选义', audioMeaning: '听音选义', durationLabel: '用时', studySeconds: '{seconds}秒', studyMinutesSeconds: '{minutes}分{seconds}秒', studyPack: '学习包', dailyReview: '日常复习', memorizationProgress: '复习 {reviewed} 词 · 不熟 {unfamiliar} 词', vocabularyPlanProgress: '主学 {main} 词 · 到期复习 {review} 词 · 不熟 {unfamiliar} 词', dictationProgress: '正确 {correct}/{total} · 错词 {wrong}',
