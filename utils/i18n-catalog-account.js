module.exports = {
  ...
  settings: {
    'zh-CN': {
      ...
      warmTheme: '雾蓝玻璃', libraryTheme: '图书馆静谧', voyageTheme: '伟大航路', dragonTheme: '龙珠修炼', tacticalTheme: '战术行动', zhHans: '中文简体', english: 'English'
    },
    en: {
      ...
      warmTheme: 'Mist Glass', libraryTheme: 'Quiet Library', voyageTheme: 'Grand Voyage', dragonTheme: 'Dragon Training', tacticalTheme: 'Tactical Ops', zhHans: 'Simplified Chinese', english: 'English'
    }
  },
  family: {
    'zh-CN': {
  ...
  parentDetail: {
    'zh-CN': {
      ...
      pronunciationContent: '发音 {pronunciation} · 内容 {content}', repeatScoreDetail: '准确度 {accuracy} · 流利度 {fluency} · 完整度 {completion}', listening: '听力', reading: '阅读', grammar: '语法', writing: '写作', vocabulary: '词汇', complete: '完成', listeningCourse: '听力课程', completionRecord: '完成记录',
      viewStudyPack: '查看学习包', viewOriginalAnalysis: '查看原题和分析', score: '{score} 分', scoreFraction: '{score}/{total} 分', questionCount: '{correct}/{total} 题',
      memorization: '背诵', dictation: '听写', wordMeaning: '看词选义', audioMeaning: '听音选义', durationLabel: '用时', totalDurationLabel: '累计用时', mainStudyLabel: '主学', dueReviewLabel: '到期复习', reviewedLabel: '复习', unfamiliarLabel: '不熟', correctLabel: '正确', wrongLabel: '错词', wordCount: '{count}词', studySeconds: '{seconds}秒', studyMinutesSeconds: '{minutes}分{seconds}秒', studyPack: '学习包', dailyReview: '日常复习', memorizationProgress: '复习 {reviewed} 词 · 不熟 {unfamiliar} 词', vocabularyPlanProgress: '主学 {main} 词 · 到期复习 {review} 词 · 不熟 {unfamiliar} 词', dictationProgress: '正确 {correct}/{total} · 错词 {wrong}',
    ...
    en: {
      ...
      pronunciationContent: 'Pronunciation {pronunciation} · Content {content}', repeatScoreDetail: 'Accuracy {accuracy} · Fluency {fluency} · Completion {completion}', listening: 'Listening', reading: 'Reading', grammar: 'Grammar', writing: 'Writing', vocabulary: 'Vocabulary', complete: 'Completed', listeningCourse: 'Listening lesson', completionRecord: 'Completion record',
      ...
      memorization: 'Review', dictation: 'Dictation', wordMeaning: 'Word to Meaning', audioMeaning: 'Sound to Meaning', durationLabel: 'Time', totalDurationLabel: 'Total time', mainStudyLabel: 'Main study', dueReviewLabel: 'Due review', reviewedLabel: 'Reviewed', unfamiliarLabel: 'Unfamiliar', correctLabel: 'Correct', wrongLabel: 'Wrong', wordCount: '{count} words', studySeconds: '{seconds}s', studyMinutesSeconds: '{minutes}m {seconds}s', studyPack: 'Study pack', dailyReview: 'Daily review', memorizationProgress: 'Reviewed {reviewed} words · Unfamiliar {unfamiliar}', vocabularyPlanProgress: 'Main {main} words · Due review {review} words · Unfamiliar {unfamiliar}', dictationProgress: 'Correct {correct}/{total} · Wrong {wrong}',
