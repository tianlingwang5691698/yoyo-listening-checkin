module.exports = {
  ...
  parentDetail: {
    'zh-CN': {
      ...
      contentArchive: '内容档案', onDemand: '按需查看', openDossier: '打开当天内容案卷', dossierCopy: '阅读、语法、写作和学习包会在这里展开。', open: '打开',
      ...
      pronunciationContent: '发音 {pronunciation} · 内容 {content}', listening: '听力', reading: '阅读', grammar: '语法', writing: '写作', complete: '完成', listeningCourse: '听力课程', completionRecord: '完成记录',
    ...
    en: {
      ...
      contentArchive: 'Learning content', onDemand: 'View on demand', openDossier: 'Open this day’s learning content', dossierCopy: 'Reading, grammar, writing, and study packs will appear here.', open: 'Open',
      ...
      pronunciationContent: 'Pronunciation {pronunciation} · Content {content}', listening: 'Listening', reading: 'Reading', grammar: 'Grammar', writing: 'Writing', complete: 'Completed', listeningCourse: 'Listening lesson', completionRecord: 'Completion record',
